...
public class TopMusicAdapter extends BaseAdapter {
    ...
    public TopMusicAdapter(Context context, int layout, ArrayList<TopMusicItem> items){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            holder.albumImg = (ImageView) convertView.findViewById(R.id.topMusicImg);
            holder.albumRank = (TextView) convertView.findViewById(R.id.topMusicRanking);
            holder.albumTitle = (TextView) convertView.findViewById(R.id.topMusicTitle);
            holder.albumArtist = (TextView) convertView.findViewById(R.id.topMusicArtist);
            holder.play = (ImageButton) convertView.findViewById(R.id.topMusicPlayBtn);
            holder.info = (ImageButton) convertView.findViewById(R.id.topMusicMore);
                ...
                if(loginBoolean){
                    try{
                        ...
                        if(count != 1){
                            ...
                            Log.e("mainTopMusic","title ? " + items.get(position).getTitle());
                            Log.e("mainTopMusic","artist ? " + items.get(position).getArtist());
                            Log.e("mainTopMusic","albumImg ? " + items.get(position).getAlbumImg());
                        } else {
                        ...
                        e.printStackTrace();
                        Log.e("TopMusicDatabaseException","데이터베이스를 가져올 수 없음.");
                    }
                } else {
